...
public class RedisUtil {
    ...
    */
	...
	protected Jedis getJedis(){
    	return getPool(ConfigUtil.configMap.get("jedis_url"), Integer.parseInt(ConfigUtil.configMap.get("jedis_port"))).getResource();
    }
