...
import com.tk.cn.utils.TtyException;

/**
 * <p>Title: </p>
 * <p>Description: 请求参数验证工具类</p>
 * <p>Company: www.tk.com</p>   
 * @author   tangkuo
 * @date    2017年3月19日 下午6:46:11
 */
public final class RequestCheckUtils {
    public static final String ERROR_CODE_ARGUMENTS_MISS = "error_code_arguments_miss"; // Missing // Required // Arguments
