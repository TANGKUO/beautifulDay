...
public final class PermissionConstant {
	 ...
	 * 用户按钮资源列表
	 */
	public static final String USER_RESC_BUTTON_LIST="rescButtonList";
	 ...
	 * 验证码不正确
	 */
	public static final String LOGINUSER_OR_CODE = "您输入的验证码不正确 ";
	/**
	 * 用户名或密码不正确
	 */
	public static final String LOGINUSER_OR_PASSWORD_NOT_CORRECT = "您输入的用户名或密码不正确或者用户锁定或无此账户 ";
	/**
	 * 该用户已被锁定
	 */
...
//	public static final String PRIVILEGE_SUPPLI = "SUPPLI";
    ...
    public static final String ECOS_RESC_TYPE_MENU="0";

    public static final String ECOS_RESC_TYPE_BUTTON="1";
