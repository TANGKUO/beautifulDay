...
/**
 * <p>Title: </p>
 * <p>Description: 反射方法类</p>
 * <p>Company: www.tk.com</p>   
 * @author   tangkuo
 * @date    2017年3月21日 下午10:35:56
 */
	...
	*/
	...
	public static final boolean Init(ArrayClasses ac)
	{
		...
		try {
			...
			log.error("[BaseMapping error]: class init failed,"+e.getMessage());
			rt = false;
		} 
		return rt;
	}
	...
	private String serviceExecutor(Method method, String json)
		...
		return (String) method.invoke(this, new Object[] { json });
	}
}
