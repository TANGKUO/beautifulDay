 ...
 * 只要在单个测试类前，加上注解：@RunWith(MultiThreadRunner.class),
 * 就可以并发的执行用例。 )
 * @author tangkuo
 * @date 2017年6月28日 下午10:22:13
 *
 */
public class MultiThreadedRunner extends BlockJUnit4ClassRunner {
	...
	// Runs the test corresponding to child，which can be assumed to be an
	// element of the list returned by getChildren()
	@Override
	...
	// childrenInvoker() call runChild(Object, RunNotifier) on each object
